...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json(
      { error: "Failed to fetch stats", totalSentUSD: "0", totalTransactions: 0, averageFeePercent: "1", activeSenders: 0, totalSentMUSD: "0", totalRecipients: 0, avgTransferTimeSeconds: 0 },
      { status: 500 }
    );
  }
}
