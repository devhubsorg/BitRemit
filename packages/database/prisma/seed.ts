...
async function main() {
  ...
  console.log(
    `📱 Created recipients: ${mamaIngozi.name}, ${sisterAna.name}, ${uncleKwame.name}`,
  );
  ...
  await prisma.transaction.create({
    data: {
      txHash:
        "0xabc2000000000000000000000000000000000000000000000000000000000002",
      senderId: user1.id,
      recipientId: mamaIngozi.id,
      musdAmount: 50.0,
      feeAmount: 0.5,
  ...
  await prisma.transaction.create({
    data: {
      txHash:
        "0xabc3000000000000000000000000000000000000000000000000000000000003",
      senderId: user1.id,
  ...
  await prisma.transaction.create({
    data: {
      txHash:
        "0xabc4000000000000000000000000000000000000000000000000000000000004",
      senderId: user1.id,
  ...
  await prisma.transaction.create({
    data: {
      txHash:
        "0xabc5000000000000000000000000000000000000000000000000000000000005",
      senderId: user2.id,
      recipientId: mamaIngozi.id,
      musdAmount: 75.0,
      feeAmount: 0.75,
